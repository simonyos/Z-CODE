...
func (r *Registry) BuildSystemPrompt() string {
	...
	sb.WriteString("You MUST use this EXACT XML format when calling tools. Do NOT abbreviate, shorten, or modify this format in any way.\n\n")

	sb.WriteString("CORRECT FORMAT (you must use this exact structure):\n")
	sb.WriteString("```xml\n")
	...
	sb.WriteString("WRONG FORMAT (do NOT use these):\n")
	sb.WriteString("- <tool_call> call_1 read_file README.md  ❌ WRONG\n")
	sb.WriteString("- <tool_call name=\"read_file\" path=\"README.md\"/>  ❌ WRONG\n")
	sb.WriteString("- read_file(path=\"README.md\")  ❌ WRONG\n\n")

	sb.WriteString("For multiple tools, wrap them in <tool_calls>:\n")
	sb.WriteString("```xml\n")
	...
	sb.WriteString("    <name>list_dir</name>\n")
	sb.WriteString("    <parameters>\n")
	...
	sb.WriteString("1. Every <tool_call> MUST have <id>, <name>, and <parameters> as separate XML elements\n")
	sb.WriteString("2. Parameters go INSIDE the <parameters> element as child elements\n")
	sb.WriteString("3. Do NOT put parameters as attributes on the tool_call tag\n")
	sb.WriteString("4. Do NOT compress or flatten the XML structure\n")
	sb.WriteString("5. When calling tools, output ONLY the XML with no other text\n\n")
